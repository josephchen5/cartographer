...
//从work_queue_中不断的取函数ComputeConstraintsForNode()出来进行计算.
//至少返回的结果是进行WorkItem::Result::kRunOptimization;为止.
...
//等待所有的计算完成.--被RunFinalOptimization()调用.
